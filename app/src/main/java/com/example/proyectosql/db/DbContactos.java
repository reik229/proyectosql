...
public class  DbContactos extends DbHelper {
    ...
    public ArrayList<Contactos> mostrarContactos() {
        ...
        cursorContactos = db.rawQuery("SELECT * FROM " + TABLA_CONTATOS, null);
    ...
    public Contactos verContactos(int id) {
        ...
        cursorContactos = db.rawQuery("SELECT * FROM " + TABLA_CONTATOS + " WHERE id = " + id + " LIMIT 1", null);
    ...
    public boolean editarContacto(int id, String nombre, String telefono, String correo_electronico) {
        ...
        try {
            ...
            db.execSQL("UPDATE " + TABLA_CONTATOS + " SET nombre = '" + nombre + "', telefono = '" + telefono + "', correo_electronico = '" + correo_electronico + "' WHERE id = " + id);
            correcto = true;
        } catch (Exception ex) {
            ex.toString();
            correcto = false;
